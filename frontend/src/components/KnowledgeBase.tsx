      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">Deel en ontdek waardevolle security kennis</p>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              <div className="flex gap-3">
                <select
                  ...
                  className="px-4 py-3 border border-gray-200 rounded-xl focus:border-blue-500 focus:ring-blue-500 bg-white"
                >
                ...
                <Button 
                  ...
                  variant="outline"
                  className="px-4 py-3 border-gray-200 hover:bg-gray-50 rounded-xl"
                >
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-600 mb-2">Geen artikelen gevonden</h3>
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              {entries.map((entry) => (
                <Card 
                  key={entry.id} 
                  className="group hover:shadow-xl transition-all duration-300 cursor-pointer border-0 shadow-lg hover:-translate-y-1 bg-white"
                  onClick={() => {
                ...
                >
                  {entry.image_path && (
                    <div className="h-48 bg-gradient-to-r from-blue-400 to-purple-500 rounded-t-xl relative overflow-hidden">
                      <img 
